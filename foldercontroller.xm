...
%hook SBIconPreviousLocationInfo
-(id) folderName {
return %orig;
}
%end
...
%hook SBIconListModel
-(bool) addIcon:(id)arg1 asDirty:(bool) {
return TRUE;
}
%end
...
%hook SBFolderController
-(bool) folderController:(id)arg1 draggedIconDidMoveFromListView:(id)arg2 toListView:(id) {
return %orig;
}
%end

%hook SBFolderController
-(void) folderController:(id)arg1 draggedIconShouldDropFromListView:(id) {
return %orig;
}
%end

%hook SBFolderController
-(bool) folderController:(id)arg1 draggedIconMightDropFromListView:(id) {
return %orig;
}
%end
